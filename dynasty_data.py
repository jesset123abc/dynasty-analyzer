...
# ---------------------------------------------------------------------------
# Draft pick values — Superflex format, updated July 2026 (post-2026-rookie-draft)
# Calibrated from KTC's live rookie-pick market + projected 2027 draft order.
# ---------------------------------------------------------------------------

PICK_VALUES = {
    # 2027 picks only — the 2026 rookie draft is complete (all 2026 picks consumed).
    # Slots = projected 2027 draft order from the season Monte Carlo (July 2026);
    # values calibrated to live KTC rookie-pick quotes (Early 1st 7055 / Mid 5609 / Late 4918).
    # 2027 1st round (projected order)
    "Jesse's 2027 1st":     {"ktc": 7050, "note": "proj 1.01"},
    "Brad's 2027 1st":      {"ktc": 6550, "note": "proj 1.02"},
    "Alex's 2027 1st":      {"ktc": 6150, "note": "proj 1.03"},
    "Driscoll's 2027 1st":  {"ktc": 5850, "note": "proj 1.04 — held by Jesse"},
    "Lubin's 2027 1st":     {"ktc": 5600, "note": "proj 1.05"},
    "Berkowitz's 2027 1st": {"ktc": 5400, "note": "proj 1.06"},
    "Denton's 2027 1st":    {"ktc": 5250, "note": "proj 1.07"},
    "Alexa's 2027 1st":     {"ktc": 5100, "note": "proj 1.08"},
    "Schueler's 2027 1st":  {"ktc": 5000, "note": "proj 1.09"},
    "Patrick's 2027 1st":   {"ktc": 4900, "note": "proj 1.10"},
    # 2027 2nd round (projected order)
    "Jesse's 2027 2nd":     {"ktc": 3860, "note": "proj 2.01 — held by Patrick"},
    "Brad's 2027 2nd":      {"ktc": 3720, "note": "proj 2.02"},
    "Alex's 2027 2nd":      {"ktc": 3600, "note": "proj 2.03"},
    "Driscoll's 2027 2nd":  {"ktc": 3500, "note": "proj 2.04"},
    "Lubin's 2027 2nd":     {"ktc": 3425, "note": "proj 2.05"},
    "Berkowitz's 2027 2nd": {"ktc": 3370, "note": "proj 2.06"},
    "Denton's 2027 2nd":    {"ktc": 3320, "note": "proj 2.07"},
    "Alexa's 2027 2nd":     {"ktc": 3270, "note": "proj 2.08 — held by Jesse"},
    "Schueler's 2027 2nd":  {"ktc": 3210, "note": "proj 2.09"},
    "Patrick's 2027 2nd":   {"ktc": 3150, "note": "proj 2.10"},
    # 2027 3rd round (projected order)
    "Jesse's 2027 3rd":     {"ktc": 2660, "note": "proj 3.01"},
    "Brad's 2027 3rd":      {"ktc": 2610, "note": "proj 3.02 — held by Alexa"},
    "Alex's 2027 3rd":      {"ktc": 2560, "note": "proj 3.03"},
    "Driscoll's 2027 3rd":  {"ktc": 2515, "note": "proj 3.04"},
    "Lubin's 2027 3rd":     {"ktc": 2480, "note": "proj 3.05"},
    "Berkowitz's 2027 3rd": {"ktc": 2450, "note": "proj 3.06"},
    "Denton's 2027 3rd":    {"ktc": 2410, "note": "proj 3.07"},
    "Alexa's 2027 3rd":     {"ktc": 2350, "note": "proj 3.08"},
    "Schueler's 2027 3rd":  {"ktc": 2300, "note": "proj 3.09"},
    "Patrick's 2027 3rd":   {"ktc": 2240, "note": "proj 3.10"},
    # 2027 4th round (projected order)
    "Jesse's 2027 4th":     {"ktc": 1870, "note": "proj 4.01"},
    "Brad's 2027 4th":      {"ktc": 1840, "note": "proj 4.02"},
    "Alex's 2027 4th":      {"ktc": 1815, "note": "proj 4.03"},
    "Driscoll's 2027 4th":  {"ktc": 1790, "note": "proj 4.04"},
    "Lubin's 2027 4th":     {"ktc": 1770, "note": "proj 4.05"},
    "Berkowitz's 2027 4th": {"ktc": 1750, "note": "proj 4.06"},
    "Denton's 2027 4th":    {"ktc": 1730, "note": "proj 4.07"},
    "Alexa's 2027 4th":     {"ktc": 1710, "note": "proj 4.08"},
    "Schueler's 2027 4th":  {"ktc": 1685, "note": "proj 4.09"},
    "Patrick's 2027 4th":   {"ktc": 1660, "note": "proj 4.10"},
}
